...
const Dashboard: React.FC = () => {
  ...
  }, []); // loadSensorData dependency kaldırıldı
          ...
          <div className="col-12">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex align-items-center gap-2">
                <div className={`badge ${isUsingCachedData ? 'bg-warning-subtle text-warning-emphasis' : 'bg-success-subtle text-success-emphasis'}`}>
                  <i className={`bi ${isUsingCachedData ? 'bi-wifi-off' : 'bi-wifi'} me-1`}></i>
